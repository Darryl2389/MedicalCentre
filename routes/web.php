...
Route::delete('/admin/doctors/{id}/destroy', 'Admin\DoctorController@destroy')->name('admin.doctors.destroy');
...
Route::delete('/admin/patients/{id}/destroy', 'Admin\PatientController@destroy')->name('admin.patients.destroy');
...
Route::delete('/admin/visits/{id}/destroy', 'Admin\VisitController@destroy')->name('admin.visits.destroy');
...
Route::delete('/doctor/visits/{id}/destroy', 'Doctor\VisitController@destroy')->name('doctor.visits.destroy');
...
Route::delete('/doctor/patients/{id}/destroy', 'Doctor\PatientController@destroy')->name('doctor.patients.destroy');
...
Route::delete('/patient/visits/{id}/destroy', 'Patient\VisitController@destroy')->name('patient.visits.destroy');#
